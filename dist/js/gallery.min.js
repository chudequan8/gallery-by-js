function addPhoto(t,e){for(var n=t.wrap,a="",o="",s=0;s<e.length;s++){var r='<div class="photo photo-front" id="photo_'+s+'"><div class="photo-wrap"><div class="side side-front"><p class="image"><img src="dist/img/'+e[s].img+'" alt="'+e[s].title+'"></p><p class="caption"><span>'+e[s].title+'</span></p></div><div class="side side-back"><p class="desc"><span>'+e[s].desc+"</span></p></div></div></div>",l='<li class="dot" id="dot_'+s+'"></li>';a+=r,o+=l}o='<div class="nav"><ul>'+o+"</ul></div>",n.innerHTML=a+o,n.style.display="block",t.sort(random([0,e.length])),t.turn(),[].forEach.call(document.querySelectorAll(".desc"),function(t){Ps.initialize(t)})}function random(t){var e=Math.max(t[0],t[1]),n=Math.min(t[0],t[1]),a=e-n;return Math.floor(Math.random()*a+n)}function getIndex(t,e){for(var n=0;n<t.length;n++)if(t[n]===e)return n}function turnBack(t,e,n,a){var o=t.className;o.indexOf("photo-center")!=-1?o.indexOf("photo-front")!=-1?(t.className=o.replace(/photo-front/,"photo-back"),e.className+=" back"):o.indexOf("photo-back")!=-1?(t.className=o.replace(/photo-back/,"photo-front"),e.className=e.className.replace(/\s*back\s*/,"")):alert("请为photo添加正面或反面的样式"):a.sort(n)}function randomSort(t,e){for(var n=e.splice(0,Math.floor(e.length/2)),a=e,o=n[0].clientWidth,s=n[0].clientHeight,r=t.clientWidth,l=t.clientHeight,i=0,c=n.length;i<c;i++)n[i].style.top=random([-s/2,l-s/2])+"px",n[i].style.left=random([-o/2,r/2-o])+"px",n[i].style.margin=0;for(var i=0,c=a.length;i<c;i++)a[i].style.top=random([-s/2,l-s/2])+"px",a[i].style.left=random([r/2,r-o/2])+"px",a[i].style.margin=0}function annularSort(t,e){for(var n=e.splice(0,Math.floor(e.length/2)),a=e,o=t.clientWidth,s=t.clientHeight,r=Math.min(o,s)/2,l=0,i=n.length;l<i;l++)n[l].style.transform="rotate("+random([105,270])+"deg) translate("+r+"px)";for(var l=0,i=a.length;l<i;l++)a[l].style.transform="rotate("+random([-90,75])+"deg) translate("+r+"px)"}function dotScroll(t){var e,n,a,o,s,r=t,l=r.querySelector("ul");r.ontouchstart=function(t){var a=getStyle(l,"transform");a=a.split(","),e=parseInt(a[4]),n=t.touches[0].clientX,o=new Date-0},r.ontouchmove=function(t){t.preventDefault(),l.style.transition="transform 0s",a=t.touches[0].clientX,l.style.transform="translateX("+(e+a-n)+"px)"},r.ontouchend=function(t){s=new Date-0,null!=a&&(s-o<300&&Math.abs(a-n)<30||(e+=a-n,e<-300?e=-300:e>0&&(e=0),a=null,l.style.transition="transform 0.3s ease-out",l.style.transform="translateX("+-(30*Math.ceil(Math.abs(e/30)))+"px)"))}}function getStyle(t,e){return t.currentStyle?t.currentStyle[e]:getComputedStyle(t,!1)[e]}var Gallery=function(){window.Gallery=this};Gallery.prototype.turn=function(){for(var t=this,e=(t.wrap,t.photoList),n=t.dotList,a=0;a<e.length;a++)e[a].onclick=function(e){return function(a){turnBack(this,n[e],e,t),a.preventDefault(),a.stopPropagation()}}(a),n[a].onclick=function(n){return function(a){turnBack(e[n],this,n,t),a.preventDefault(),a.stopPropagation()}}(a)},Gallery.prototype.init=function(t){this.options=t?t:"random",this.wrap=document.getElementById("wrap");var e=new XMLHttpRequest;e.open("GET","dist/data/data.json"),e.send(),e.onreadystatechange=function(){if(4===e.readyState)if(200===e.status){var t=JSON.parse(e.responseText);addPhoto(this,t)}else alert("发生错误"+e.status)}.bind(this);var n=null;window.onresize=function(){null==n&&(n=setTimeout(function(){this.sort(random([0,this.photoList.length])),n=null}.bind(this),2e3))}.bind(this),document.addEventListener("touchmove",function(t){t.cancelable&&(t.defaultPrevented||t.preventDefault())},!1)},Gallery.prototype.sort=function(t){this.photoList=document.getElementsByClassName("photo"),this.dotList=document.getElementsByClassName("dot");for(var e=this.wrap,n=this.photoList,a=this.dotList,o=n[t],s=[],r=this.options,l=document.getElementsByClassName("nav")[0],i=l.querySelector("ul"),c=0;c<n.length;c++){var d=n[c];d.removeAttribute("style"),d.className=d.className.replace("photo-back","photo-front"),d.className=d.className.replace(/\s*photo-center\s*/,""),s.push(d),a[c].className="dot",a[c].innerHTML=c+1}o.className+=" photo-center",document.body.clientWidth<768&&(l.style.width="150px",l.style.marginLeft="-75px",t<2?i.style.transform="translateX(0)":t>a.length-3?i.style.transform="translateX("+30*-(a.length-5)+"px)":i.style.transform="translateX("+30*-(t-2)+"px)"),a[t].className+=" current fa fa-undo",a[t].innerHTML="",s.splice(t,1),"random"===r?randomSort(e,s):"annular"===r?annularSort(e,s):alert("没有这种排序方式，请重新指定"),dotScroll(l)};
